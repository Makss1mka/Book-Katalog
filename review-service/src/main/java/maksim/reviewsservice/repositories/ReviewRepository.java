...
public interface ReviewRepository extends JpaRepository<Review, Integer> {
    ...
    @Query("SELECT r FROM Review r LEFT JOIN FETCH r.likedUsers u WHERE r.id = :id")
    ...
    @Query("SELECT r FROM Review r LEFT JOIN FETCH r.likedUsers u WHERE r.userId = :userId")
    ...
    @Query("SELECT r FROM Review r LEFT JOIN FETCH r.likedUsers u WHERE r.bookId = :bookId")
